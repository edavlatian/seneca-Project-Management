<%-- 
    Document   : PendingProjects
    Created on : Mar 12, 2012, 12:41:03 PM
    Author     : KepneR
--%>
        ...
        <td>
          ...
          <form name="form1" method="POST" action="ProjectDetails.jsp">
            ...
            <%
                    ...
                    out.println("<div style='float: left'><input type='hidden' name='pending' value='1' /></div>");
                    out.println("<div style='float: right'>");
                    int pages = (int) Math.ceil( (double) projects.size() / items);
                    out.println(" Page(s): ");
                    for(int i = 0; i < pages; i++) {
                        out.println("<a href='PendingProjects.jsp?beg=" + i + "&items=" + items + "'>"+ (i + 1) + "</a> | ");
                    }
