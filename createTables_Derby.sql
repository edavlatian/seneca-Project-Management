...
CREATE TABLE TEAMS (
  teamId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE COMPANY (
  companyId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE PROJECTS (
  projectId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE MILESTONE (
  milestoneId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE COMMENTS (
  commentId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE TEAMMEMBER (
  memberId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE PROJECTFILE (
  fileId INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
